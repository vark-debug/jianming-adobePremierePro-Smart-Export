...
- **示例** ([main.vue#L275-L282](../src/main.vue#L275-L282)):
  ```vue
...
- UXP 插件自动重载（需确保 [uxp.config.ts#L7](../uxp.config.ts#L7) 中 `hotReloadPort` = 8080）
...
- **错误追踪**: 开发模式启用 sourcemap ([vite.config.ts#L17](../vite.config.ts#L17))
...
### 权限错误
- 检查 [uxp.config.ts#L100-L127](../uxp.config.ts#L100-L127) 的 `requiredPermissions`
- 文件系统需要 `localFileSystem: "fullAccess"`

### 构建错误: "Cannot resolve module 'premierepro'"
- 确保在 [vite.config.ts#L21-L28](../vite.config.ts#L21-L28) 的 `rollupOptions.external` 中声明

### 热重载失败
- 检查端口 8080 是否被占用
- 确认 [uxp.config.ts#L7](../uxp.config.ts#L7) 中 `hotReloadPort` 与 Vite 配置一致
